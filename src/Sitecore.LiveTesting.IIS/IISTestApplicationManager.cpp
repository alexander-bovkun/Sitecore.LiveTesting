...
Sitecore::LiveTesting::IIS::Applications::IISTestApplicationManager::~IISTestApplicationManager()
{
  if (!m_disposed)
  {
    HostedWebCore->~HostedWebCore();
